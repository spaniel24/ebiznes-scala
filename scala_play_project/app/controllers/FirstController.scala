...
class FirstController @Inject()(val controllerComponents: ControllerComponents) extends BaseController {
  ...
  itemsList += FirstItemModel(1, "Pierwszy")
  itemsList += FirstItemModel(2, "Drugi")
  itemsList += FirstItemModel(3, "Trzeci")
  itemsList += FirstItemModel(4, "Czwarty")
  itemsList += FirstItemModel(5, "Piąty")
