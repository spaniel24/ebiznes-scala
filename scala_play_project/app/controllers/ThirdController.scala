...
class ThirdController @Inject()(val controllerComponents: ControllerComponents) extends BaseController {
  ...
  itemsList += FirstItemModel(1, "Pierwszy z trzeciej")
  itemsList += FirstItemModel(2, "Drugi z trzeciej")
  itemsList += FirstItemModel(3, "Trzeci z trzeciej")
  itemsList += FirstItemModel(4, "Czwarty z trzeciej")
  itemsList += FirstItemModel(5, "Piąty z trzeciej")
